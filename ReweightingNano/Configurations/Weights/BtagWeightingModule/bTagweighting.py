...
def calculatebtagWeight(self, theTree):
    ...
    elif (theTree.gFatJet_pt >= 250 and theTree.gFatJet_pt < 300):
        btagWeighting = jsonInfo["250_300"]["nominal"]
    
    elif (theTree.gFatJet_pt >= 300 and theTree.gFatJet_pt < 350):
        btagWeighting = jsonInfo["300_350"]["nominal"]
    
    elif (theTree.gFatJet_pt >= 350 and theTree.gFatJet_pt < 400):
        btagWeighting = jsonInfo["350_400"]["nominal"]
    
    elif (theTree.gFatJet_pt >= 400 and theTree.gFatJet_pt < 450):
        btagWeighting = jsonInfo["400_450"]["nominal"]
    
    elif (theTree.gFatJet_pt >= 450 and theTree.gFatJet_pt < 500):
        btagWeighting = jsonInfo["450_500"]["nominal"]

    elif (theTree.gFatJet_pt >= 500 and theTree.gFatJet_pt < 600):
        btagWeighting = jsonInfo["500_600"]["nominal"]
    
    elif (theTree.gFatJet_pt >= 600 and theTree.gFatJet_pt < 700):
        btagWeighting = jsonInfo["600_700"]["nominal"]
    
    elif (theTree.gFatJet_pt >= 700 and theTree.gFatJet_pt < 800):
        btagWeighting = jsonInfo["700_800"]["nominal"]
    
    elif (theTree.gFatJet_pt >= 800):
...
with open(btagWeight_2016.jsonSFFile,'r') as jsonFile:
