...
Radion_M1800Config.inputFile_tt = jsonInfo[Radion_M1800Config.name]['file_tt']
Radion_M1800Config.inputFile_et = jsonInfo[Radion_M1800Config.name]['file_et']
Radion_M1800Config.inputFile_mt = jsonInfo[Radion_M1800Config.name]['file_mt']
...
Radion_M1800Config.listOfWeights = list
