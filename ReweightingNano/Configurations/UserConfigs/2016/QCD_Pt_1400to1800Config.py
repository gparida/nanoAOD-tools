...
QCD_Pt_1400to1800Config.jsonSampleFile = os.environ['CMSSW_BASE']+'/src/PhysicsTools/NanoAODTools/Samples/2016_Samples.json'
...
QCD_Pt_1400to1800Config.inputFile_tt = jsonInfo[QCD_Pt_1400to1800Config.name]['file_tt']
QCD_Pt_1400to1800Config.inputFile_et = jsonInfo[QCD_Pt_1400to1800Config.name]['file_et']
QCD_Pt_1400to1800Config.inputFile_mt = jsonInfo[QCD_Pt_1400to1800Config.name]['file_mt']
...
QCD_Pt_1400to1800Config.listOfWeights = list
