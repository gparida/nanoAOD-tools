...
Radion_M1600Config.jsonSampleFile = os.environ['CMSSW_BASE']+'/src/PhysicsTools/NanoAODTools/Samples/2016_Samples.json'
...
Radion_M1600Config.inputFile_tt = jsonInfo[Radion_M1600Config.name]['file_tt']
Radion_M1600Config.inputFile_et = jsonInfo[Radion_M1600Config.name]['file_et']
Radion_M1600Config.inputFile_mt = jsonInfo[Radion_M1600Config.name]['file_mt']
...
Radion_M1600Config.listOfWeights = list
