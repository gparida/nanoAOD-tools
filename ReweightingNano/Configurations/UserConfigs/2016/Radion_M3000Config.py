...
Radion_M3000Config.jsonSampleFile = os.environ['CMSSW_BASE']+'/src/PhysicsTools/NanoAODTools/Samples/2016_Samples.json'
...
Radion_M3000Config.inputFile_tt = jsonInfo[Radion_M3000Config.name]['file_tt']
Radion_M3000Config.inputFile_et = jsonInfo[Radion_M3000Config.name]['file_et']
Radion_M3000Config.inputFile_mt = jsonInfo[Radion_M3000Config.name]['file_mt']
...
Radion_M3000Config.listOfWeights = list
