...
def main():
    ...
    parser.add_argument('--standardCutString',
                        ...
                        default="(channel==0 || channel==1 || channel==2)")
...
#
    ...
    ##############################Legend############################    
        ...
        theLegend.AddEntry(Signal_Histo,'Signal','l')
...
#
    ...
    #############################Saving The Plots####################################
        ...
        theCanvas.SaveAs('PrelimPlots/'+variableAxisTitleDictionary[variable]+'_'+args.year+'.pdf')
        ...
        ShapeCanvas.SaveAs('PrelimPlots/'+ "Normalized" +variableAxisTitleDictionary[variable]+'_'+args.year+'.pdf')
