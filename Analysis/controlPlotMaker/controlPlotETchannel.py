...
def main():
    ...
    if args.year == '2016':
        dataPath = '/data/gparida/Background_Samples/bbtautauAnalysis/2016/et_Channel/allTau_VM_DR_1/'
    elif args.year == '2017':
...
#
    ...
    #############################Saving The Plots####################################
        ...
        theCanvas.SaveAs('ETPlots/'+variable+'_'+args.year+'.pdf')
        ...
        ShapeCanvas.SaveAs('ETPlots/'+ "Normalized" +variable+'_'+args.year+'.pdf')
